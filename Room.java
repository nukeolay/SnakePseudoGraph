...
public class Room {
    ...
    static {
        try {
            BufferedReader highScoreFile = new BufferedReader(new FileReader("Score.dat"));
    ...
    public void run() throws IOException {
        ...
        if (snake.getSections().size() > highScore) {
            ...
            try {
                FileWriter newHighScoreFile = new FileWriter("Score.dat");
                newHighScoreFile.write(String.valueOf(snake.getSections().size()));
    ...
    public void print() {
        ...
        System.out.println("Score: " + snake.getSections().size());
